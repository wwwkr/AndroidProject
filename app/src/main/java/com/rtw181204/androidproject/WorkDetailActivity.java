...
public class WorkDetailActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Initialize Database
        mPostReference = FirebaseDatabase.getInstance().getReference().child("work")
                .child("posts").child(mPostKey);
        mCommentsReference = FirebaseDatabase.getInstance().getReference().child("work")
    ...
    public void onStart() {
        ...
        ValueEventListener postListener = new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if(post==null){
                    Toast.makeText(WorkDetailActivity.this, "데이터없음", Toast.LENGTH_SHORT).show();
                    return;
                }
                // [START_EXCLUDE]
            ...
            public void onCancelled(DatabaseError databaseError) {
                ...
                // [START_EXCLUDE]
                Toast.makeText(WorkDetailActivity.this, "Failed to load post.",
                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if(commentText.trim().length()==0){
                            Toast.makeText(WorkDetailActivity.this, "내용을 입력하세요.", Toast.LENGTH_SHORT).show();
                            return;
                        }
