...
public class InfoGroupActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("모임모집");

        mPagerAdapter = new FragmentPagerAdapter(getSupportFragmentManager()) {

            private final Fragment[] mFragments = new Fragment[]{

                    new GroupPostsFragment(),
                    new GroupMyPostsFragment(),
                    new GroupMyTopPostsFragment()
            };
    ...
    public void clcikNewPost(View view) {
        ...
        startActivity(new Intent(InfoGroupActivity.this, InfoGroupWriteActivity.class));
    }
}
