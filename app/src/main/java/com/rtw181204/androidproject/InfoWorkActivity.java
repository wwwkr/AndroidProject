...
public class InfoWorkActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("구인구직");

        mPagerAdapter = new FragmentPagerAdapter(getSupportFragmentManager()) {

            private final Fragment[] mFragments = new Fragment[]{

                    new WorkPostsFragment(),
                    new WorkMyPostsFragment(),
                    new WorkMyTopPostsFragment()
            };
    ...
    public void clcikNewPost(View view) {
        startActivity(new Intent(InfoWorkActivity.this, InfoWorkWriteActivity.class));
